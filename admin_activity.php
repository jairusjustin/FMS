        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="plantingForm">
                    ...
                    <div class="mb-3">
                        <label for="seededArea" class="form-label">Seeded Area (ha)</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="savePlanting()">Add Planting</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="harvestForm">
                    ...
                    <div class="mb-3">
                        <label for="harvest_quantity" class="form-label">Harvest Quantity (kg)</label>
                        <input type="number"step="0.01" min="0.01" class="form-control" id="harvest_quantity" name="harvest_quantity" required>
                    </div>
                    <!-- Expense Input -->
                    <div class="mb-3">
                        <label for="expenseAmount" class="form-label">Expense Amount (₱)</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="saveHarvest()">Add Harvest</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="addOtherActivityModal" tabindex="-1" aria-labelledby="addOtherActivityModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="saveOtherActivity()">Add Activity</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                ...
                <form id="editOtherActivityForm">
                    ...
                    <div class="mb-3" id="edit_harvest_quantity" style="display: none;">
                        <label for="edit_harvest_quantity" class="form-label">Harvest Quantity (kg)</label>
