    ...
    <div class="col-md-6">
        <div class="my-recentOrders">
            ...
            <div class="my-card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $row_farm['farm_name']; ?></h5>
                        <p class="card-text">Location: <?php echo $row_farm['farm_location']; ?></p>
                        <p class="card-text">Size: <?php echo number_format($total_size, 1); ?> ha</p>
                        <button class="btn editFarmBtn" onclick="editFarm()">Edit</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="farmForm" method="post" action="update_farm.php">
                    <input type="hidden" name="farm_id" value="<?php echo $row_farm['farm_id']; ?>">
                    <div class="mb-3">
                        <label for="farmName" class="form-label">Farm Name:</label>
                        <input type="text" class="form-control" id="farmName" name="farmName" value="<?php echo $row_farm['farm_name']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="farmLocation" class="form-label">Farm Location:</label>
                        <input type="text" class="form-control" id="farmLocation" name="farmLocation" value="<?php echo $row_farm['farm_location']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="farmSize" class="form-label">Farm Size (ha):</label>
                        <input type="text" class="form-control" id="farmSize" name="farmSize" value="<?php echo number_format($total_size, 1); ?>" readonly>
                    </div>
